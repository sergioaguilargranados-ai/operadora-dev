                  ...
                  {mobileContent?.sections_json?.docs?.terms_url && (
                    <div className="flex items-start gap-2">
                      ...
                      <label htmlFor="terms_mobile" className="text-sm text-gray-700">
                        Acepto los <a href={mobileContent.sections_json.docs.terms_url} target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:underline font-medium">Términos y Condiciones</a>
                      </label>
                    </div>
                  )}
