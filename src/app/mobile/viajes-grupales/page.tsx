      ...
      <div className="px-6 space-y-6">
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
          ...
          <Button 
            ...
            className="w-full bg-brand-primary text-white hover:bg-brand-primary-hover rounded-xl font-bold h-12 shadow-sm mb-6 flex items-center justify-center gap-2"
          >
          ...
          <div className="flex justify-around items-center px-2">
            ...
            <SocialButton color="bg-brand-primary" name="Facebook" icon={<FacebookIcon />} onClick={() => handleShare('facebook')} />
        ...
        <div className="bg-white rounded-3xl p-5 border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)]">
          ...
          <div className="grid grid-cols-3 gap-y-4 gap-x-2 text-center">
            ...
            <MiniBenefit icon={<Briefcase className="w-5 h-5 text-brand-primary" />} color="bg-blue-50" text="Tours gratuitos" />
