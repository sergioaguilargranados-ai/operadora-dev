...
export async function PUT(
  ...
  try {
    ...
    const updatedCommission = await updateOne('agency_commissions', parseInt(params.id), updates)
...
export async function DELETE(
  ...
  try {
    ...
    const updatedCommission = await updateOne('agency_commissions', parseInt(params.id), {
      status: 'cancelled',
