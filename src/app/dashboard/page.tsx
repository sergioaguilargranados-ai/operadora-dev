              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: `Hay ${stats.receivables?.data?.vencidas || 0} cuentas vencidas por revisar`
                    })
                    // TODO: Navegar a vista filtrada de cuentas vencidas
                  }}
                >
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: "Se enviarán recordatorios a todas las cuentas pendientes"
                    })
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      title: "Nueva Cuenta",
                      description: "Abriendo formulario de cuenta por cobrar..."
                    })
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: `Hay ${stats.payables?.data?.pendientes || 0} pagos próximos a vencer`
                    })
                    // TODO: Navegar a vista de pagos próximos
                  }}
                >
                  Ver pagos próximos
                </Button>
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: "Abriendo formulario de registro de pago..."
                    })
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      title: "Nueva Cuenta",
                      description: "Abriendo formulario de cuenta por pagar..."
                    })
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Button
                  ...
                  onClick={async () => {
                    try {
                      const token = localStorage.getItem('token')
                      const res = await fetch('/api/commissions?action=by-agency', {
                        headers: { 'Authorization': `Bearer ${token}` }
                      })
                      const data = await res.json()
                      toast({
                        title: "Comisiones por Agencia",
                        description: `Se encontraron ${data.data?.length || 0} agencias`
                      })
                      // TODO: Mostrar modal con datos detallados
                    } catch (error) {
                      toast({
                        variant: "destructive",
                        title: "Error",
                ...
                <Button
                  ...
                  onClick={() => {
                    toast({
                      title: "Marcar Comisión",
                      description: "Selecciona una comisión para marcar como pagada"
                    })
                    // TODO: Mostrar lista de comisiones pendientes
                  }}
                >
                  Marcar como pagada
                </Button>
                <Button
                  ...
                  onClick={() => {
                    toast({
                      ...
                      description: "Calculando comisiones pendientes del mes..."
                    })
                    // TODO: Ejecutar cálculo de comisiones
                  }}
                >
                  Calcular comisiones
                </Button>
