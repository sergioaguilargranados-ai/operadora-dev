  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setError("Veo que tienes reservas pero no has configurado tu contraseña. Por favor revisa tu correo electrónico para el enlace de acceso, o inicia sesión con Google si usaste esa cuenta.")
      } else {
