# AG-Sesión: Estandarización de Layouts Intranet, Eliminación de Cenefas Duplicadas y Restauración de Menú Vertical v2.481

> **Fecha:** 2026-08-15 02:31 CST  
> **Versión alcanzada:** `v2.481`  
...
- `src/components/layout/PortalSidebar.tsx`: Agregado submenú de *Panel de Empresas* y eliminación de atajos al fondo.
...
- `DOCS/AG-Historico-Cambios.md`: Registro de versión `v2.481`.
- `DOCS/AG-Contexto-Proyecto.md`: Actualización de estado y versión `v2.481`.
