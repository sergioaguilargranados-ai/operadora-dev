...
function PaymentSuccessContent() {
  ...
  // Parámetros de diferentes fuentes de pago
  const directBookingId = searchParams.get('bookingId')
  ...
  const bookingId = directBookingId || (bookingIdMatch ? bookingIdMatch[1] : null)
  ...
  useEffect(() => {
    ...
    // Limpiar localStorage - el pago fue exitoso
    localStorage.removeItem('reserva_temp')
    localStorage.removeItem('selected_service')
    localStorage.removeItem('pendingBooking')

    // TODO: Si es MercadoPago, actualizar estado del pago en BD
    if (source === 'mercadopago' && paymentId) {
      console.log('MercadoPago payment confirmed:', paymentId)
    }
