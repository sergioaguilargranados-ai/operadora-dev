...
export default function Home() {
  ...
  // Lista de destinos populares para sugerencias
  const popularDestinations = [
    "Cancún, México", "Los Cabos, México", "Puerto Vallarta, México",
    "Ciudad de México, México", "Guadalajara, México", "Tulum, México",
    "Riviera Maya, México", "Playa del Carmen, México", "Oaxaca, México",
    "San Miguel de Allende, México", "Mérida, México", "Acapulco, México",
    "Huatulco, México", "Ixtapa, México", "Mazatlán, México",
    "Nueva York, USA", "Miami, USA", "Los Angeles, USA", "Las Vegas, USA",
    "París, Francia", "Madrid, España", "Barcelona, España", "Roma, Italia"
  ]
