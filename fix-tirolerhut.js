...
const fixes = {
  "sombrero tirolés (tirolerhut)": "https://upload.wikimedia.org/wikipedia/commons/d/d2/Tyrolean_hat_3.jpg"
};
...
async function run() {
  ...
  for (const it of itRes.rows) {
    ...
    if (updated) {
      ...
      console.log(`Updated itinerary ID ${it.id} for EXACT tirolean hat!`);
    }
  }
  pool.end();
}
